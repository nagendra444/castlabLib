 ...
 * @author hgoebl
 */
public class mmHTTPResponse<T> {
    final mmHTTPRequest request;
    ...
    mmHTTPResponse(mmHTTPRequest request) {
    ...
    public void ensureSuccess() {
        if (!isSuccess()) {
            throw new mmHTTPException("Request failed: " + statusCode + " " + responseMessage, (mmHTTPResponse) this);
        }
    }
}
