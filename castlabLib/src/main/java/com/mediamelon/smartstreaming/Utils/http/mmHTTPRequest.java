...
public class mmHTTPRequest {
    ...
    private final mmHTTPClient httpClient;
    final Method method;
    final String uri;
    ...
    mmHTTPRequest(mmHTTPClient httpClient, Method method, String uri) {
     ...
     * @since 1.3.0
     */
    public mmHTTPRequest multipleValues() {
        multipleValues = true;
        return this;
    }
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest param(String name, Object value) {
        if (params == null) {
     ...
     * @since 1.3.0
     */
    public mmHTTPRequest param(String name, Iterable<Object> values) {
        if (params == null) {
            params = new LinkedHashMap<String, Object>();
        }
        params.put(name, values);
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest params(Map<String, Object> valueByName) {
        if (params == null) {
            params = new LinkedHashMap<String, Object>();
        }
     ...
     * <br>
     * Setting a header this way has the highest precedence and overrides a header value set on a {@link mmHTTPClient}
     * instance ({@link mmHTTPClient#setDefaultHeader(String, Object)}) or a global header
     * ({@link mmHTTPClient#setGlobalHeader(String, Object)}).
     * <br>
     ...
     *             names as constants in {@link mmHTTPClient}, see HDR_xxx.
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest header(String name, Object value) {
        if (headers == null) {
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest body(Object body) {
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest useCaches(boolean useCaches) {
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest ifModifiedSince(long ifModifiedSince) {
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest connectTimeout(int connectTimeout) {
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest readTimeout(int readTimeout) {
     ...
     * If you want to change the behaviour for all your requests, call {@link mmHTTPClient#setFollowRedirects(boolean)}.
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest followRedirects(boolean auto) {
        this.followRedirects = auto;
        return this;
    }

    /**
     * By calling this method, the HTTP status code is checked and a <code>mmHttpException</code> is thrown if
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest ensureSuccess() {
     ...
     * in the thrown `mmHTTPException`. You can check this with {@link mmHTTPException#getCause()}.
     ...
     * @return <code>this</code> for method chaining (fluent API)
     */
    public mmHTTPRequest retry(int retryCount, boolean waitExponential) {
        if (retryCount < 0) {
            retryCount = 0;
        }
        if (retryCount > 10) {
     ...
     */
    public mmHTTPResponse<String> asString() {
        return httpClient.execute(this, String.class);
    }
     ...
     */
    public mmHTTPResponse<JSONObject> asJsonObject() {
        return httpClient.execute(this, JSONObject.class);
    }
     ...
     */
    public mmHTTPResponse<JSONArray> asJsonArray() {
        return httpClient.execute(this, JSONArray.class);
    }
     ...
     */
    public mmHTTPResponse<byte[]> asBytes() {
        return (mmHTTPResponse<byte[]>) httpClient.execute(this, mmHTTPConst.BYTE_ARRAY_CLASS);
    }
     ...
     */
    public mmHTTPResponse<InputStream> asStream() {
        return httpClient.execute(this, InputStream.class);
    }
     ...
     */
    public mmHTTPResponse<Void> asVoid() {
        return httpClient.execute(this, Void.class);
    }
